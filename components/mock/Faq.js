...
const mockArr = [
  {
    Icon: <TbPencilStar size={60} color="#642891" />,
  ...
  {
    Icon: <GiStarFormation size={60} color="#642891" />,
  ...
  {
    Icon: <RiFileSettingsLine size={60} color="#642891" />,
  ...
  {
    Icon: <GiAlliedStar size={60} color="#642891" />,
      ...
      <Container $pt={80} $pb={80}>
        ...
        <Flex $align="flex-start" $justify="space-between" $gap={20}>
          {mockArr.map((item, index) => (
            <FlexInner $direction="column" $gap={10} key={index}>
              {item.Icon}
              <H2>
